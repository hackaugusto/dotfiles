...
brew install jq tmux semgrep pinentry-mac gpg tig iterm2 showkey svn podman lima scrcpy the_silver_searcher mold emscripten pre-commit gnuplot graphviz openjdk golang
