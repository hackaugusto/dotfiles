...
vim.api.nvim_create_autocmd({ "cursorhold", "bufwritepost" }, {
	...
	callback = function()
		vim.b.statusline_trailing_space_warning = nil
	end,
})
...
vim.api.nvim_create_autocmd({ "cursorhold", "bufwritepost" }, {
	callback = function()
		vim.b.statusline_tab_warning = nil
	end,
})
...
function LoclistErrors()
	...
	local errors = Filter(loclist, function(v)
		return v.type == "E"
	end)
...
function LoclistWarnings()
	local loclist = vim.fn.getloclist(0)
	local warnings = Filter(loclist, function(v)
		return v.type == "W"
	end)
	...
	use({
		...
		config = function()
			...
			registry.refresh(function()
				...
				registry.get_package("flake8"):install()
				registry.get_package("mypy"):install()
				registry.get_package("pylint"):install()
				-- lua
